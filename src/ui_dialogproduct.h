...
public:
    ...
    void setupUi(QDialog *DialogProduct)
    {
        ...
        gridLayout->addWidget(lineEdit_stock, 7, 2, 1, 1);
        ...
        gridLayout->addWidget(comboBox_tax, 6, 2, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_code, 4, 2, 1, 1);
        ...
        gridLayout->addWidget(comboBox_categories, 4, 4, 1, 1);
        ...
        gridLayout->addWidget(toolButton_editCategorie, 4, 5, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_description, 3, 2, 1, 1);
        ...
        gridLayout->addWidget(comboBox_providers, 3, 4, 1, 1);
        ...
        gridLayout->addWidget(toolButton_editProvider, 3, 5, 1, 1);

        label_tax = new QLabel(DialogProduct);
        label_tax->setObjectName(QString::fromUtf8("label_tax"));

        gridLayout->addWidget(label_tax, 5, 5, 1, 1);
        ...
        gridLayout->addWidget(doubleSpinBox_buyingPrice, 5, 2, 1, 1);
        ...
        gridLayout->addWidget(doubleSpinBox_price, 5, 4, 1, 1);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/app/On"), QSize(), QIcon::Normal, QIcon::Off);
        radioButton_OK->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/app/quit"), QSize(), QIcon::Normal, QIcon::Off);
        radioButton_Discontinued->setIcon(icon3);
        ...
        QWidget::setTabOrder(lineEdit_code, comboBox_categories);
        ...
        QWidget::setTabOrder(comboBox_tax, lineEdit_stock);
